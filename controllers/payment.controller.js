...
import orderModel from "../models/processOrder.model.js";
...
export const paymentVerification = async (req, res) => {
  try {
    ...
    const orderFind = await orderModel.findOne({
    ...
    if (isAuthentic) {
      ...
      res.redirect(`${process.env.CLIENT_URL}/my_orders?reference=${razorpay_payment_id}`);
    } else {
      res.status(400).json({
        success: false,
      });
